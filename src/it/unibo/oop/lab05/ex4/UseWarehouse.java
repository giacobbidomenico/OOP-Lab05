...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ComparableProduct("Sapone",200);
        final Product p2 = new ComparableProduct("Prosciutto",400);
        final Product p3 = new ComparableProduct("Miele",786);
